...
<body>
    <div id="header">
        <img src="Image/BTEC1.PNG" alt="BTEC logo" width = "160" height = "150">
    ...
    <div id="footer">
        <p><b>BTEC Cần Thơ</b> &#169; NgocHai_Bc00083<br></p>
        <i>Address:</i>Phong Nam,Ke Sach,Soc Trang <br>
        <i>Phone:</i> +84 372210873
    </div>
